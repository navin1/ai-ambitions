    ...
    <div className="min-h-screen w-full flex bg-white">
      ...
      <div className="flex-1 flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-sm">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-xl shadow-gray-200/60 p-8 flex flex-col items-center text-center">
            {done ? (
              <>
                ...
                <h2 className="text-lg font-semibold text-gray-900 mb-1">You've been signed out</h2>
                <p className="text-sm text-gray-500 mb-6">Your session has ended. Sign in again to access the dashboard.</p>
                <button
              ...
              <>
                <Loader2 size={24} className="text-gray-400 animate-spin mb-4" />
